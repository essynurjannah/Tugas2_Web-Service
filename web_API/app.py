#6B/19090009/Esy Nurjanah
#6B/19090008/Naimatul Maudiyah
...
database = 'sqlite:///' + os.path.join(filename, 'EsyNana.db')
app.config['SQLALCHEMY_DATABASE_URI'] = database
app.config['SECRET_KEY'] = "naes0222"
...
class infopengguna(Resource):
    def post(self):
        ...
        return jsonify({"Msg ":"Gagal Memuat Info"}) 
